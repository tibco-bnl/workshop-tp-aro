...
- [Firewall Requirements](../docs/firewall-requirements) - Complete list of required endpoints including ARO-specific requirements
- [Network Security Group Rules](../docs/firewall-requirements#10-network-security-group-nsg-rules-for-azure)
- [Azure Firewall Rules](../docs/firewall-requirements#11-azure-firewall-application-rules)
- [Firewall Request Template](../docs/firewall-requirements#17-simplified-firewall-request-template)
- [OpenShift Proxy Configuration](../docs/firewall-requirements#12-proxy-configuration)
